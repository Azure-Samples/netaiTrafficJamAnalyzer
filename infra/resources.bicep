...
resource sqlTrafficjamanalyzerapphostC29722572eSqlDataFileShare 'Microsoft.Storage/storageAccounts/fileServices/shares@2022-05-01' = {
  parent: storageVolumeFileService
  name: take('${toLower('sql')}-${toLower('trafficjamanalyzerapphostc29722572esqldata')}', 60)
  properties: {
    shareQuota: 1024
...
resource sqlTrafficjamanalyzerapphostC29722572eSqlDataStore 'Microsoft.App/managedEnvironments/storages@2023-05-01' = {
  parent: containerAppEnvironment
  name: take('${toLower('sql')}-${toLower('trafficjamanalyzerapphostc29722572esqldata')}', 32)
  properties: {
    azureFile: {
      shareName: sqlTrafficjamanalyzerapphostC29722572eSqlDataFileShare.name
...
output SERVICE_SQL_VOLUME_TRAFFICJAMANALYZERAPPHOSTC29722572ESQLDATA_NAME string = sqlTrafficjamanalyzerapphostC29722572eSqlDataStore.name
